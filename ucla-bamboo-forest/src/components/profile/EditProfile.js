import { Button, FormControl, FormLabel, HStack, Modal, ModalBody, 
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            <Button loadingText="Uploading" w="full" my="6" colorScheme="blue"
                onClick={updateAvatar} isLoading={fileLoading}>
              Save
            </Button>
          </ModalBody>
        </ModalContent>
